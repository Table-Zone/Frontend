      ...
      <div className="flex-1 min-w-0">
        <div className="lg:hidden h-16 bg-tz-cream dark:bg-gray-900 flex items-center px-4 sticky top-0 z-30 relative">
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-xl bg-tz-cream-dark dark:bg-gray-800 border border-tz-cream-dark/60 dark:border-gray-700 shrink-0"
          >
