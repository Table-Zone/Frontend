...
interface DemoMenuItem { name: string; price: string; desc: string; img: string; cal: string }
interface DemoTab { label: string; sections: { heading: string; headingColor: string; items: DemoMenuItem[] }[] }

const PHONE_TABS: DemoTab[] = [
  {
    label: 'البرجر',
    sections: [
      {
...
const DEMO_MENUS: Record<'ar' | 'en', { restaurant: DemoTab[]; cafe: DemoTab[] }> = {
...
function PhoneMock({ tabs = PHONE_TABS }: { tabs?: DemoTab[] }) {
