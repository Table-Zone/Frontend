...
import type { MenuDisplayData } from './types';
...
/* ========================================================================
   ...
   ======================================================================== */
export function NoirTemplate({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
                  ...
                  {cat.items.map((item: any) => (
                    <div key={item.id} className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                        ...
                        <ItemDetailTags details={item.details} isEnglish={isEnglish} className="flex flex-wrap gap-2 mt-2" spanClassName="text-xs font-semibold px-2.5 py-1 rounded border border-current/20 opacity-80" />
                      </div>
                    </div>
                  ))}
                </div>
...
/* ========================================================================
   ...
   ======================================================================== */
export function EditorialTemplate({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
                ...
                {cat.items.map((item: any, idx: number) => (
                  <div key={item.id} className={`flex flex-col sm:flex-row gap-5 ${idx % 2 === 1 ? 'sm:flex-row-reverse' : ''}`}>
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                      ...
                      <ItemDetailTags details={item.details} isEnglish={isEnglish} className="flex flex-wrap gap-2 mt-2" spanClassName="text-xs font-bold px-3 py-1.5 rounded-full opacity-90" />
                    </div>
                  </div>
                ))}
              </div>
...
/* ========================================================================
   ...
   ======================================================================== */
export function PosterTemplate({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
...
/* ========================================================================
   ...
   ======================================================================== */
export function TakerTemplate({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
...
/* ========================================================================
   ...
   ======================================================================== */
export function BistroTemplate({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
...
/* ========================================================================
   RENDERER — picks the right template
   ======================================================================== */
export function MenuTemplateRenderer({ menu, isEnglish }: { menu: MenuDisplayData; isEnglish: boolean }) {
  switch (menu.templateId) {
    case 'editorial': return <EditorialTemplate menu={menu} isEnglish={isEnglish} />;
    case 'poster':    return <PosterTemplate    menu={menu} isEnglish={isEnglish} />;
    case 'taker':     return <TakerTemplate     menu={menu} isEnglish={isEnglish} />;
    case 'bistro':    return <BistroTemplate    menu={menu} isEnglish={isEnglish} />;
    default:          return <NoirTemplate      menu={menu} isEnglish={isEnglish} />;
  }
}
