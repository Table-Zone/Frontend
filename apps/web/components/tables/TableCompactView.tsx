        ...
        {isOccupied ? (
          <div className="flex gap-1.5">
            ...
            <div className="relative" ref={transferPickerRef}>
              ...
              {showTransferPicker && (
                <div className={`absolute bottom-10 ${isRTL ? 'left-0' : 'right-0'} z-20 min-w-[140px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl py-2 overflow-hidden`}>
